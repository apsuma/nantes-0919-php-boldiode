...
class RoomManager extends AbstractManager
{
    ...
    {
        $query = "SELECT r.name room_name, r.description, r.nb_bed, r.surface, r.front_page, ";
        $query .= "p.price_summer, p.price_winter, p.name price_name, ";
        $query .= "v.name view_name, t.name theme_name FROM room r INNER JOIN price p ON r.id_price = p.id ";
